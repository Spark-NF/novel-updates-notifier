...
rollup "dist/popup/popup.js" -o "src/popup/bundle.js" --no-treeshake -f "iife" -e "vue" -g "vue:Vue"
rollup "dist/options/options.js" -o "src/options/bundle.js" --no-treeshake -f "esm"
rollup "dist/options/groups.js" -o "src/options/groups.js" --no-treeshake -f "iife" -e "vue" -g "vue:Vue"
