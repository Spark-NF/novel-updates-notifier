...
cp -f "node_modules/font-awesome/fonts/fontawesome-webfont.woff2" "src/vendor/"
cp -f "node_modules/vue/dist/vue.min.js" "src/vendor/js/"
cp -f "node_modules/vue-class-component/dist/vue-class-component.min.js" "src/vendor/js/"
